...
class PDController(Node):
    ...
    def control(self):
        ...
        angle_vel = self.Kp[0]*self.th_diff + self.Kd[0]*self.theta_change_rate
        linear_vel = self.Kp[1]*self.pos_diff + self.Kd[1]*self.error_change_rate_norm

        if abs(self.th_diff) > 0.2: 
            linear_vel = 0.0
            angle_vel *= 2
            

        self.vel_cmd = (linear_vel, angle_vel)
